    ...
    <div className="min-h-screen w-full text-white overflow-hidden">
      <div className="relative min-h-[calc(100vh-4rem)] flex items-center justify-center" id='home'>
        <div className="relative z-10 text-center px-6 max-w-7xl mx-auto">
          <div className="mb-12 sm:mb-16 mt-[10vh] inline-flex items-center justify-center">
            <span className="text-lg md:text-2xl font-bold bg-gradient-to-r from-blue-400 to-cyan-400 bg-clip-text text-transparent">Sandbox Research</span>
          </div>
          <h1 className="font-extrabold leading-tight text-center">
            <span className="text-4xl md:text-6xl inline-block opacity-0 animate-fadeInUp font-bold sm:text-4xl md:text-6xl">
              Build a Strategy That Wins.
            </span>
            <span className="text-2xl md:text-4xl block mt-4 sm:mt-10 mb-12 sm:mb-16 opacity-0 animate-fadeInUp animation-delay-200 font-bold sm:text-4xl md:text-5xl">
              Any Industry.<br />
          ...
          <p className="text-lg md:text-xl text-gray-400 max-w-3xl mx-auto mb-12 md:mb-16 opacity-0 animate-fadeInUp animation-delay-400">
            Winning is a strategy.<br></br>
            Dominate in <span className="text-white font-semibold">politics</span>, <span className="text-white font-semibold">business</span>, <span className="text-white font-semibold">marketing</span> and <span className="text-white font-semibold">more.</span><br></br><br />
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-4 mb-8 opacity-0 animate-fadeInUp animation-delay-500">
          ...
          <div className="flex flex-col sm:flex-row max-w-[250px] gap-4 justify-center ml-auto mr-auto mb-6 opacity-0 animate-fadeInUp animation-delay-600">
